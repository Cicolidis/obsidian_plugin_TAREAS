  ...
  .record(
    {
      ...
      due: fc.option(fc.constantFrom("2026-08-29", "2026-01-01", "1", "10", "31"), { nil: null }),
      rec: fc.option(fc.constantFrom("lunes", "mensual", "mudanza", "semana en el cole"), {
        nil: null,
      }),
...
const CAMPOS = {
  ...
  due: fc.option(fc.constantFrom("2026-08-29", "2026-01-01", "10"), { nil: null }),
  rec: fc.option(fc.constantFrom("lunes", "mensual", "mudanza"), { nil: null }),
  prioridad: fc.constantFrom<0 | 1 | 2>(0, 1, 2),
  done: fc.option(fc.constantFrom("2026-08-30"), { nil: null }),
} as const;
